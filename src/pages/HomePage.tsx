...
import { Feather, Quote, Trees as Tree, Globe, Scroll, MapPin, Leaf, BookOpen } from "lucide-react"
      ...
      <div className="min-h-screen">
        ...
        <div className="relative h-screen overflow-hidden">
          <div
            ...
            style={{
              backgroundImage:
                'url("https://images.unsplash.com/photo-1500382017468-9049fed747ef?ixlib=rb-1.2.1&auto=format&fit=crop&w=2000&q=80")',
          ...
          >
            <div className="max-w-4xl">
              ...
              <p className="text-xl md:text-2xl text-stone-200 italic">"Lietuva brangi, mano tėvyne"</p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-16 space-y-32">
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-lg text-stone-600 leading-relaxed">
                Jonas Mačiulis-Maironis (1862-1932) - lietuvių tautos dainius, kurio kūryba tapo mūsų kultūros ir
                tapatybės pagrindu. Šiandien jo žodžiai skamba dar aktualiau, kviesdami mus saugoti gamtą, puoselėti
                kultūrą ir stiprinti tautinę savimonę.
              </p>
            </div>
            ...
            <div className="relative grid md:grid-cols-3 gap-8">
              <motion.div whileHover={{ scale: 1.05 }} className="card">
                ...
                <p className="text-stone-600">
                  Maironio poezija - tai tiltas tarp praeities ir dabarties, jungianti lietuvių tautos istorinę atmintį
                  su šiandienos iššūkiais.
                </p>
              </motion.div>
              <motion.div whileHover={{ scale: 1.05 }} className="card">
                ...
                <p className="text-stone-600">
                  Poeto meilė Lietuvos gamtai šiandien įkvepia mus saugoti ir puoselėti mūsų krašto gamtos grožį bei
                  biologinę įvairovę.
                </p>
              </motion.div>
              <motion.div whileHover={{ scale: 1.05 }} className="card">
                ...
                <p className="text-stone-600">
                  Maironio kūryba - tai kvietimas išsaugoti ir puoselėti lietuvių kalbą, tradicijas ir kultūrinį
                  paveldą.
                </p>
              </motion.div>
            </div>
          ...
          <section className="space-y-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <motion.div whileHover={{ scale: 1.02 }} className="card bg-nature-100">
              ...
              <motion.div whileHover={{ scale: 1.02 }} className="card bg-heritage-100">
          ...
          <section className="relative">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <motion.div whileHover={{ scale: 1.05 }} className="card">
                ...
                <p className="text-stone-600">Rotušės a. 13, Kaunas - muziejus, kuriame poetas gyveno ir kūrė.</p>
              </motion.div>
              <motion.div whileHover={{ scale: 1.05 }} className="card">
                <Leaf className="w-8 h-8 mb-4 text-lt-green" />
                <h3 className="font-bold mb-2">Betygalos apylinkės</h3>
                <p className="text-stone-600">Poeto gimtinė, įkvėpusi daugelį jo gamtos aprašymų.</p>
              </motion.div>
              <motion.div whileHover={{ scale: 1.05 }} className="card">
                <BookOpen className="w-8 h-8 mb-4 text-heritage-500" />
                <h3 className="font-bold mb-2">Kauno kunigų seminarija</h3>
                <p className="text-stone-600">Vieta, kur Maironis dėstė ir vadovavo būsimiems kunigams.</p>
              </motion.div>
            </div>
          </section>
        </div>
        ...
        <footer className="bg-stone-900 text-stone-400 py-12 mt-32">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <p className="text-sm">© 2024 | Puoselėkime lietuvių kalbą, kultūrą ir gamtą</p>
          </div>
        </footer>
      </div>
    </PageTransition>
